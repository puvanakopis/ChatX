    ...
    const chats: ChatItem[] = [
        {
            ...
            time: "Now",
            avatar:
                "https://lh3.googleusercontent.com/aida-public/AB6AXuDu0xItwy-q2SrftqDFt3JiRpBUKVlf-62bK4cj36mhEz7aeEKZ5kveRcl_V4Epd2oHNQ43Ask2gnNAjwB97XVw4zqn6Z-Gd6CHOPsunEuuLhPeKT3WUyb7G4RN1oMkc35cEXgvk4UzTMKSPa39PV7eAveQEiGAhjKBNX8Ugh2NojKq38A1ZLRbWgQ3VGxHqOLVr8XZVXZMpmqiS9lp2VnRJrcX2lYWUBSUQY4d4xdjk_rJQc3xyX3hUNKSP0mj0neJbxioaKml5rh0",
        },
        {
            id: 2,
            name: "Design Team",
            ...
            time: "2m",
            avatar:
                "https://lh3.googleusercontent.com/aida-public/AB6AXuCljU2bb9Nv13UeZnpx7Iqtsm7FMMdP-NEwIE9pLzoOCH9D8XXh9qWokCjvM2aYiWkrEZgjanZWIDR_6yUqF6aQrwpbW4NRjMzKzDZ8vaPVFN2fZb2xjk20vGXeM0fX0y_YTirUlrwqPB49rKewP5KBgWd7Hk6q4LmWUPGcVD484cDHtRHYOYGNdEZQcej34KSDeZH1FuQYrTc8rf8n49YbGpULDK-cLVOeJRnBSIX4DF83_tPYZLeC_pDwIPT5v9sixnINCCXJ-fzk",
            unread: 3,
        },
        {
            id: 3,
            ...
            time: "1h",
            avatar:
                "https://lh3.googleusercontent.com/aida-public/AB6AXuDY3lcVG0fsza6F0BsLowLMYPk-ggItQ0pv8Dp_xJrjwx-AcZ2TsSJEzPR-iNpXaDKUxfZMCGAVBitHcpj5P4AGVAYWjIYGYJs67-bJd8WLzqn0CVKJD2U1qAll_DHZdXrI7NQWFDQtY94DXvnuy39WdLUU8_gOrF_KUnfgS_bG2WS8t1Nya1dgO_djiAz7h7qcVmgw9PyKcnYW5q5fCW1_Ptyej5v5CUfFSUouXGwiXeH0QyBTVYFJ9HTXuMianjhFYAei7kIYsGc5",
        },
        {
            id: 4,
            name: "Marketing Team",
            message: "New campaign assets",
            time: "2d",
            avatar: "",
        },
    ];
            ...
            >
                ...
                <div className="flex flex-col flex-1 text-left min-w-0">
                    <div className="flex justify-between items-baseline">
                        <p
                            className={`truncate text-sm font-bold ${isActive ? "text-white" : "text-white/80 group-hover:text-white"
                                }`}
                        >
                            {chat.name}
                        </p>
                        <p className={`text-xs font-medium whitespace-nowrap ml-2 ${isActive ? "text-[#3b82f6]" : "text-[#94a3b8]"}`}>
                            {chat.time}
                        </p>
                    </div>
                    <p className={`truncate text-sm mt-0.5 ${isActive ? "text-white/90" : "text-white/80 group-hover:text-white/90"}`}>
                        {chat.message}
                    </p>
                </div>
                ...
                {!isActive && chat.unread && (
                    <div className="shrink-0 flex items-center justify-center w-5 h-5 rounded-full bg-[#3b82f6] text-[#0f172a] text-[10px] font-bold">
                        {chat.unread}
                    </div>
                )}
            </button>
    ...
    return (
        <aside className="w-[360px] flex flex-col h-full bg-[#0f172a] border-r border-[#334155] shrink-0">
            ...
            <div className="px-4 pb-4">
                <div className="flex w-full items-center rounded-xl bg-[#1e293b] border border-[#475569] transition-colors overflow-hidden h-12">
