    ...
    return (
        <main className="flex-1 bg-[#020617] flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="flex flex-col items-center gap-6 z-10 opacity-50">
                <div className="size-24 rounded-2xl bg-[#1e293b] border border-[#475569] flex items-center justify-center">
                    <span className="material-symbols-outlined text-[#475569] text-[48px]">
